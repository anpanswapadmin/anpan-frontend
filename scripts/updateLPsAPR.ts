...
const BLOCK_SUBGRAPH_ENDPOINT = 'https://api.thegraph.com/subgraphs/name/anpanswap/blocks'
const EXCHANGE_SUBGRAPH_ENDPOINT = 'https://api.thegraph.com/subgraphs/name/anpanswap/exchange'
