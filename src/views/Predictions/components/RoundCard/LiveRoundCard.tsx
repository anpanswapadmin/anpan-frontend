...
import { CardBody, Flex, PlayCircleOutlineIcon, Skeleton, Text, TooltipText, useTooltip } from '@anpanswap/uikit'
...
const GradientBorder = styled.div`
  background: linear-gradient(180deg, #53dee9 0%, #CD754C 100%);
  border-radius: 16px;
  padding: 1px;
`
