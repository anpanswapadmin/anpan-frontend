...
import { useMatchBreakpoints, useModal } from '@anpanswap/uikit'
...
const Predictions = () => {
  ...
  const [hasAcceptedRisk, setHasAcceptedRisk] = usePersistState(false, {
    localStorageKey: 'anpans_predictions_accepted_risk',
  })
  const [hasAcceptedChart, setHasAcceptedChart] = usePersistState(false, {
    localStorageKey: 'anpans_predictions_chart',
  })
