...
import { AutoRenewIcon, Button, Card, CardBody, Heading, Skeleton, Text } from '@anpanswap/uikit'
...
const ProfilePicture: React.FC = () => {
  ...
  const handleApprove = async () => {
    ...
    const tx = await contract.approve(getAnpansProfileAddress(), selectedNft.tokenId)
    setIsApproving(true)
    ...
    return (
      <>
        ...
        <Text bold fontSize="20px" mb="24px">
          {t('We couldn’t find any Anpans Collectibles in your wallet.')}
        </Text>
        <Text as="p">
          {t(
            'You need a Anpans Collectible to finish setting up your profile. If you sold or transferred your starter collectible to another wallet, you’ll need to get it back or acquire a new one somehow. You can’t make a new starter with this wallet address.',
          )}
        </Text>
      </>
    )
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {t('Only approved Anpans Collectibles can be used.')}
