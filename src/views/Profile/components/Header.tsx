...
import { Button, Flex, Heading, useModal, PresentWonIcon } from '@anpanswap/uikit'
import { useProfile } from 'state/hooks'
import { useTranslation } from 'contexts/Localization'
import ClaimNftAndAnpanModal, { useCanClaim } from './ClaimGiftModal'
...
const ProfileHeader = () => {
  ...
  const [onPresentClaimGiftModal] = useModal(<ClaimNftAndAnpanModal onSuccess={checkClaimStatus} />)
