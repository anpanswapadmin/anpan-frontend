...
import { Flex, Box, Image } from '@anpanswap/uikit'
...
const TradingCompetition = () => {
  ...
  const { hasUserClaimed, userAnpanRewards, userPointReward, canClaimNFT } = userTradingInformation

  const userCanClaimPrizes =
    currentPhase.state === CLAIM &&
    !hasUserClaimed &&
    (userAnpanRewards !== '0' || userPointReward !== '0' || canClaimNFT)
  ...
  useEffect(() => {
    ...
    const fetchUserContract = async () => {
      ...
      const userObject = {
        ...
        userAnpanRewards: user[3].toString(),
  ...
  return (
    <CompetitionPage>
      ...
      <PageSection background={DARKBG} svgFill={DARKFILL} index={4} >
