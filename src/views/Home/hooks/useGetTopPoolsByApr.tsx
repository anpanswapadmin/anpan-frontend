...
import { fetchAnpanVaultFees, fetchPoolsPublicDataAsync } from 'state/pools'
import { simpleRpcProvider } from 'utils/providers'
import { useSelector } from 'react-redux'
import { useAnpanVault } from 'state/pools/hooks'
...
const useGetTopPoolsByApr = (isIntersecting: boolean) => {
  ...
  useEffect(() => {
    const fetchPoolsPublicData = async () => {
      ...
      try {
        await dispatch(fetchAnpanVaultFees())
  ...
  }, [setTopPools, pools, fetchStatus, anpanPriceBusd, topPools, performanceFeeAsDecimal])
