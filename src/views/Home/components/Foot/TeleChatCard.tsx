...
const TeleChatCard = () => {
  ...
  return (
    <StyledFarmStakingCard>
      <CardBodySocial>
        <StyledLink as="a" href="https://t.me/anpanswap" aria-label="Anpan Telegram Chat" target="_blank"> 
          <CardImage src="/images/telegramchat.svg" width={176.5} height={176.5}/>
        </StyledLink> 
      </CardBodySocial>
    </StyledFarmStakingCard>
  )
