...
const TeleChannelCard = () => {
  ...
  return (
    <StyledFarmStakingCard>
      <CardBodySocial>
        <StyledLink as="a" href="https://t.me/AnpanSwapAnn" aria-label="Anpan Telegram Channel" target="_blank"> 
          <CardImage src="/images/telegramchannel.svg" width={176.5} height={176.5}/>
        </StyledLink>  
      </CardBodySocial>
    </StyledFarmStakingCard>
  )
...
export default TeleChannelCard
