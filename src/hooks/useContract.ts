...
import {
  ...
  getErc721Contract,
  getAnpanVaultContract,
  getPredictionsContract,
  getChainlinkOracleContract,
  getSouschefV2Contract,
  getLotteryV2Contract,
  getBunnySpecialAnpanVaultContract,
...
export const useAnpan = () => {
  const provider = useWeb3Provider()
  return useMemo(() => getAnpanContract(provider.getSigner()), [provider])
}
...
export const useAnpansRabbits = () => {
  const provider = useWeb3Provider()
  return useMemo(() => getAnpansRabbitContract(provider.getSigner()), [provider])
}
...
export const useAnpanVaultContract = () => {
  const provider = useWeb3Provider()
  return useMemo(() => getAnpanVaultContract(provider.getSigner()), [provider])
}
...
export const useSpecialBunnyAnpanVaultContract = () => {
  const provider = useWeb3Provider()
  return useMemo(() => getBunnySpecialAnpanVaultContract(provider.getSigner()), [provider])
}
