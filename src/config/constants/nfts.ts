...
const Nfts: Nft[] = [
  ...
  {
    name: 'Honey Soak',
    description: 'Ahh... what could be sweeter than a honeyy soak?',
    images: {
      lg: 'soak-lg.png',
      md: 'soak-md.png',
      sm: 'soak-sm.png',
      ipfs: 'https://cloudflare-ipfs.com/ipfs/QmW3zLfdQpw9vWpgcDyR2WM9A34tTWvvYyjKc3JjhtL68z/honey-soak.png',
    },
    video: {
      webm: 'https://gateway.pinata.cloud/ipfs/QmW3zLfdQpw9vWpgcDyR2WM9A34tTWvvYyjKc3JjhtL68z/honey-soak.webm',
      mp4: 'https://gateway.pinata.cloud/ipfs/QmW3zLfdQpw9vWpgcDyR2WM9A34tTWvvYyjKc3JjhtL68z/honey-soak.mp4',
    },
    sortOrder: 999,
    identifier: 'honey-soak',
    type: NftType.ANPANS,
    variationId: 16,
  },
  {
    name: 'Mixie v1',
    description: 'Stories were told, and songs were sung, about Chef Mixie’s anpanss and her big Honey gun.',
    images: {
      lg: 'mixie-1-lg.png',
      md: 'mixie-1-md.png',
      sm: 'mixie-1-sm.png',
  ...
  },
  {
    ...
    description: 'Eggscellent! Celebrating Honey Storm winning the Easter Battle!',
    images: {
  ...
  {
    name: "Anpanston Easter '21",
    description: 'Melting Easter eggs and melting hearts!',
    images: {
      lg: 'anpanston-easter-21-lg.png',
      md: 'anpanston-easter-21-md.png',
      sm: 'anpanston-easter-21-sm.png',
      ipfs: 'https://cloudflare-ipfs.com/ipfs/QmZGqWaovULNEMKxBCGnGjh27JQkAyadS6AW4J4Lzf3XBp/easter-anpaner.png',
    },
    sortOrder: 999,
    identifier: 'easter-anpaner',
    type: NftType.ANPANS,
    variationId: 15,
  },
  {
  ...
  },
  {
    ...
    description: 'Do you like chocolate with your honey? Go long!',
    images: {
  ...
  {
    name: 'Sleepy',
    description: 'Aww, looks like eating anpanss all day is tough work. Sweet dreams!',
    images: {
      lg: 'sleepy-lg.png',
      md: 'sleepy-md.png',
      sm: 'sleepy-sm.png',
  ...
  {
    name: 'Sunny',
    description: 'Sunny is always cheerful when there are anpanss around. Smile!',
    images: {
      lg: 'sunny-lg.png',
      md: 'sunny-md.png',
      sm: 'sunny-sm.png',
  ...
  {
    name: 'Churro',
    description: "Don't let that dopey smile deceive you... Churro's a master ANPAN chef!",
    images: {
      lg: 'churro-lg.png',
      md: 'churro-md.png',
      sm: 'churro-sm.png',
  ...
  {
    name: 'Dollop',
    description: "Nommm... Oh hi, I'm just meditating on the meaning of ANPAN.",
    images: {
      lg: 'dollop-lg.png',
      md: 'dollop-md.png',
      sm: 'dollop-sm.png',
  ...
  {
    name: 'Twinkle',
    description: "Three guesses what's put that twinkle in those eyes! (Hint: it's ANPAN)",
    images: {
      lg: 'twinkle-lg.png',
      md: 'twinkle-md.png',
      sm: 'twinkle-sm.png',
  ...
  {
    name: 'Swapsies',
    description: 'These bunnies love nothing more than swapping anpanss. Especially on BSC.',
    images: {
      lg: 'swapsies-lg.png',
      md: 'swapsies-md.png',
      sm: 'swapsies-sm.png',
  ...
  {
    name: 'Drizzle',
    description: "It's raining honey on this bunny, but he doesn't seem to mind. Can you blame him?",
    images: {
      lg: 'drizzle-lg.png',
      md: 'drizzle-md.png',
      sm: 'drizzle-sm.png',
  ...
  {
    name: 'Blueberries',
    description: "These bunnies like their anpanss with blueberries. What's your favorite topping?",
    images: {
  ...
  {
    name: 'Circular',
    description: "Love makes the world go 'round... but so do anpanss. And these bunnies know it.",
    images: {
      lg: 'circular-lg.png',
      md: 'circular-md.png',
      sm: 'circular-sm.png',
  ...
  {
    name: 'Sparkle',
    description: 'It’s sparkling honey, anpanss, and even lottery tickets! This bunny really loves it.',
    images: {
      lg: 'sparkle-lg.png',
      md: 'sparkle-md.png',
      sm: 'sparkle-sm.png',
